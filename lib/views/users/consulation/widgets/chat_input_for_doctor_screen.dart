...
class ChatInputForDoctorScreen extends StatefulWidget {
    ChatInputForDoctorScreen({super.key, this.maxLins = 1, required this.onPressed});
  final int? maxLins;
  void Function() onPressed;
  @override
  State<ChatInputForDoctorScreen> createState() => _ChatInputForDoctorScreenState();
}

class _ChatInputForDoctorScreenState extends State<ChatInputForDoctorScreen> {
  final controller = Get.put(DoctorBottomSheetConsultationControllerImp());
